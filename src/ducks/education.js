...
export const education = [
    {
        ...
        "comments": [
            ...
            },
            {
                ...
                value: ["Advanced machine learning", "Large scale graph processing", "Parallel processing", "Advanced analysis of algorithms"]
            },
            {
                type: "Thesis topic",
                value: "Tracking and Classification of Mouse Behaviors using Convolutional Neural Networks and Recurrent Neural Networks"
            }
        ],
        "tags": [
            "computer",
    ...
    },
    {
        ...
        "comments": [
            ...
            {
                "type": "Relevant courses",
                "value": ["C++", "Java", "Python", "x86 Assembly", "Linear algebra", "Multivariable Calculus", "Differential Equations", "Bioinformatics"]
            },
            {
                "type": "Achievement",
                "value": "Programmed DirectionField app for iOS and Android that solves x'=Ax where A is a matrix of real numbers."
            }
        ],
        "tags": [
            "cs",
