...
export default function SkillExp({
  ...
  return (
    <div
      className={`${isDark ? 'text-white' : 'text-black'} basis-full md:basis-1/4 bg-info p-2 rounded-lg m-1`}
      onClick={onClick}
    >
      <div>
