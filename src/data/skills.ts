...
export const skills: Array<DataObject> = [
  {
    title: "CBT",
    subtitle: "therapy modality",
    comments: {
      info: [
        "CBT is found to be the most effective treatment for mood disorders and is by far the most researched therapy modality. I believe that understanding how thoughts can be changed and understanding how beliefs and emotions are related to thoughts are an invaluable resource in healing.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    comments: {
      info: [
        "Even though PERL was officially my first language (we officially learned C++03), C++ was the first language in which I felt comfortable programming. Though mainstream C++ has changed in the years I began learning it (with auto types and pointer changes etc.), it is still the most powerful language I know.",
      ],
    },
    tags: [
      "computer",
  ...
  },
  {
    ...
    comments: {
      info: [
        "I started working in Matlab to do analyses for a bioinformatics class. I love the power, speed, and design of the language, but hate the size. It's enormous. I like the NN packages.",
      ],
    },
    tags: [
      "computer",
  ...
  },
  {
    ...
    comments: {
      info: [
        "I lived in France in 1989 (Chamalieres/Clermont-Ferrand) and again in 2000 (Strasbourg). When I was a child, I attended Ecole Jules Ferry in the class of Mme Pironon. I studied French from 6th-12th grade in the U.S. In college, when I returned to Strasbourg, I completed an internship at l'Aide Sociale à l'Enfance in Colmar.",
      ],
      proficiencies: [
    ...
    tags: ["french", "language", "francais", "français", "spoken"],
  },
  {
    title: "German",
    from: new Date(1995, 8, 1),
    type: "language",
    comments: {
      info: [
        "I took 2 years of German in high school. When in France, in college, I often crossed the border into Germany and practiced my German.",
      ],
      proficiencies: [
        "Basic spoken capacity",
        "Basic comprehension of spoken German",
        "Basic writing capacity",
        "Basic reading capacity",
      ],
    },
    tags: ["german", "language", "deutsch"],
  },
  {
    title: "Japanese",
    from: new Date(2012, 8, 1),
    ...
    comments: {
      info: [
        "I have only taken Japanese for one year at Pasadena City College, but I hope to resume courses.",
      ],
      proficiencies: [
        "Extremely basic comprehension of spoken Japanese",
        "Extremely basic writing capacity",
      ],
    },
    tags: ["japanese", "language", "nihon", "go"],
  },
];
